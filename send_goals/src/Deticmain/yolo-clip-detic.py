...
class myVisualizationDemo(object):
    ...
    def run_on_image(self, image):
        ...
        Returns:
            detections (list): a list of dictionaries, each containing the bounding box coordinates,
                              object name, and confidence score for each detected object.
...
class RGBDepthSubscriber:
    def __init__(self):
        ...
        cfg.merge_from_file("/home/ubuntu/Desktop/catkin_turtlebot3/src/send_goals/src/Deticmain/configs/Detic_LCOCOI21k_CLIP_SwinB_896b32_4x_ft4x_max-size.yaml")
            ...
            if self.depth_image_process is not None and self.u !=0 and self.v !=0:
                ...
                if depth_value > 0  and depth_value < 10:
                    ...
                    try:
                        ...
                        self.listener.waitForTransform("map", "camera_frame_optical", self.current_time, rospy.Duration(1.0))
